...
# Load images
TOP_PIPE_IMAGE = pygame.image.load(r"c:\Users\adity\Desktop\SYMF\pipe\topipe1.png")
BOTTOM_PIPE_IMAGE = pygame.image.load(r"c:\Users\adity\Desktop\SYMF\pipe\bopipe1.png")
HEAL_IMAGE = pygame.image.load(r'c:\Users\adity\Desktop\SYMF\entities\health2.png')
powerup_image = pygame.image.load(r'c:\Users\adity\Desktop\SYMF\entities\shield2.png')
...
class Heal:
    ...
    def draw(self):
        screen.blit(HEAL_IMAGE, (self.x - self.radius, self.y - self.radius)) #pygame.draw.circle(screen, self.colour, (self.x, self.y), self.radius)
